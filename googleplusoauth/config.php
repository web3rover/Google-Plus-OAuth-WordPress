...
$apiConfig = array(
    ...
    'application_name' => get_option("googleplus_app_name"),

    // OAuth2 Settings, you can get these keys at https://code.google.com/apis/console
    'oauth2_client_id' => get_option("googleplus_client_id"),
    'oauth2_client_secret' => get_option("googleplus_client_secret"),
    'oauth2_redirect_uri' => get_site_url() . '/wp-admin/admin-ajax.php?action=googleplus_oauth_callback',
